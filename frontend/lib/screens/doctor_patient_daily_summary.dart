...
class DoctorPatientDailySummary extends StatefulWidget {
  final String patientName;

  const DoctorPatientDailySummary({
    super.key,
    required this.patientName,
  });

  @override
  State<DoctorPatientDailySummary> createState() => _DoctorPatientDailySummaryState();
}

class _DoctorPatientDailySummaryState extends State<DoctorPatientDailySummary> {
