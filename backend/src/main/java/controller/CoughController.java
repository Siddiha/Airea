...
public class CoughController {
    ...
    /**
     * ESP32 submits cough event POST /api/cough/event
     */
    @PostMapping("/event")
    ...
    /**
     * Get all cough events for a device GET /api/cough/device/{deviceId}
     */
    ...
    /**
     * Get cough events within time range GET
     * /api/cough/device/{deviceId}/range?start=...&end=...
     */
    ...
    /**
     * Get hourly statistics GET /api/cough/stats/{deviceId}/hour
     */
    ...
    /**
     * Get today's statistics GET /api/cough/stats/{deviceId}/today
     */
    ...
    /**
     * Get weekly statistics GET /api/cough/stats/{deviceId}/week
     */
